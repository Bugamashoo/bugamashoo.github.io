...
const CATASTROPHES = {
  ...
  aux_power_fault: {
    ...
    color:'var(--red)',
    narrative:`The auxiliary power fault cascaded into a complete loss of facility electrical control. Safety systems, instrumentation, and actuators all lost power simultaneously. The reactor, now without any control signals, continued operating at its last commanded state. For 94 seconds, a fusion reaction ran without human control in a facility with neither working instruments nor supervision. When emergency power was restored, operators found the core temperature at 11,400°C, coolant flow at zero, and containment integrity at 12%. The reactor had been past the automatic scram threshold for an estimated 8 seconds by the time control was recovered. That 8 seconds is now the subject of a congressional safety review that will last four years. The facility will be decommission due to safety concerns.`
  },
  fuel_exhaustion: {
    anim:'meltdown', title:'FUEL EXHAUSTION', subtitle:'ECONOMIC & OPERATIONAL COLLAPSE',
    color:'var(--amber)',
    narrative:`The reactor's fuel reserves dropped to zero with no remaining funds to purchase more. Without fuel, the plasma extinguished within seconds. The turbine spooled down, grid output flatlined, and the facility lost its only source of revenue. Emergency procurement channels were contacted, but with the facility's accounts depleted and credit lines frozen by the regulatory authority, no supplier would deliver. The reactor sat cold and dark for 72 hours before the grid operator terminated the power purchase agreement. The facility was placed into administrative receivership. Equipment was auctioned. The site will be decommissioned and replaced with coal-based power. Your contract has been terminated.`
  }
};
