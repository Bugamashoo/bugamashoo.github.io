...
function buildCar(front, middle, back) {
...
//save making and loading code
var saveInput = document.getElementById("save").value;

function makeSave() {
	return (this.partOneID + (this.partTwoID * 100) + (this.partThreeID * 10000) + (this.carModID * 1000000))
}

function loadSave() {
	var temp = saveInput;
	partOneID = (temp % 1000000);
}
